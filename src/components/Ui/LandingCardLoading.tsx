export default function LandingCardLoading() {
  return (
    <article className="h-[400px] w-[240px] cursor-pointer">
      <div className="bg-gray-400 animate-pulse h-[240px] w-full rounded-md flex items-center justify-center">
