function PrivacyPage() {
  return (
    <section className="h-screen">
      <div className="container items-center mx-auto mt-40">
        ...
        <br />
        <ol className=" h-full justify-between ">
          <li className="mb-4">
            1.<b> Information We Collect - Personal Information:</b> When you
          ...
          <li className="mb-4">
            2.<b> How We Use Your Information - Order Processing </b>: We use
            your personal information to process and fulfill your orders,
            including shipping and handling. <br /> <b>Customer Service:</b> We
            may use your contact information to respond to your inquiries,
            provide support, or notify you about updates related to your order.{" "}
            <br />
          ...
          <li className="mb-4">
            3.<b> Data Sharing and Disclosure - Service Providers </b> : We may
          ...
          <li className="mb-4">
            4.<b> Data Security </b>: We implement industry-standard security
          ...
          <li className="mb-4">
            5. <b>International Transfers</b>: As we ship worldwide, your
            personal information may be transferred and stored in countries
            outside your own. We ensure that such transfers comply with
            applicable data protection laws and are handled with adequate
            safeguards.
          </li>
          <li className="mb-4">
            6.<b> Your Rights</b>: You have the right to access, correct, or
            ...
            <a href="mailto:lazytrendy@tienda.com.ar">
              lazytrendy@tienda.com.ar
            </a>
          </li>
          <li className="mb-4">
            7.<b> Changes to This Policy</b>: We may update this Privacy Policy
            from time to time. Any changes will be posted on our website, and we
            encourage you to review this policy periodically.
          </li>
          <li className="mb-4">
            8.<b> Contact Us</b>: If you have any questions or concerns about
            this Privacy Policy, please contact us at: Lazy Trendy Mail (Falta
            hostinger)<a href="11 3230-0253"> 11 3230-0253</a>. Thank you for
            choosing Lazy Trendy. Your privacy is important to us.
          </li>
        </ol>
      </div>
    </section>
